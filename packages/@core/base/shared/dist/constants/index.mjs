...
const VBEN_GITHUB_URL = "https://github.com/midoks/fastcdn";
const VBEN_DOC_URL = "https://github.com/midoks/fastcdn/wiki";
const VBEN_LOGO_URL = "https://unpkg.com/@vbenjs/static-source@0.1.7/source/logo-v1.webp";
const VBEN_PREVIEW_URL = "https://github.com/midoks/fastcdn";
const VBEN_ELE_PREVIEW_URL = "https://github.com/midoks/fastcdn";
const VBEN_NAIVE_PREVIEW_URL = "https://github.com/midoks/fastcdn";
const VBEN_ANT_PREVIEW_URL = "https://github.com/midoks/fastcdn";
