...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/grid/src/grid.js
...
var grid_default = defineVxeComponent({
  name: "VxeGrid",
  ...
  setup(props, context) {
    ...
    const computeIsActiveMsg = computed(() => {
      const proxyOpts = computeProxyOpts.value;
      return import_xe_utils.default.isBoolean(proxyOpts.showActionMsg) ? proxyOpts.showActionMsg : !!proxyOpts.showActiveMsg;
    });
      ...
      if (pagerConfig && isEnableConf(pagerOpts)) {
        if (propKey) {
          if (pagerOpts[propKey]) {
            tablePage[propKey] = import_xe_utils.default.toNumber(pagerOpts[propKey]);
          }
        } else {
    ...
    const handleZoom = (isMax) => {
      ...
      return nextTick().then(() => $xeGrid.recalculate(true)).then(() => {
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/grid/index.js
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/vxe-grid/index.js
