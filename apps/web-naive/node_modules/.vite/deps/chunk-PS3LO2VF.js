import {
  ...
  toTreePathSeq,
  updateCellTitle
} from "./chunk-PY2ER5BD.js";
import {
  defineVxeComponent,
  errLog,
  getSlotVNs,
  warnLog
} from "./chunk-N2RO4YPH.js";
import {
  eqEmptyValue,
  formatText,
  getFuncText,
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/src/table.js
var import_xe_utils10 = __toESM(require_xe_utils());

// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/src/anime.js
...
function clearRowAnimate(elem) {
  setTimeout(() => {
    if (elem) {
      import_xe_utils.default.arrayEach(elem.querySelectorAll(`.vxe-body--row.${rowMoveCls}`), (elem2) => removeClass(elem2, rowMoveCls));
    }
  }, 500);
}
...
function clearColAnimate(elem) {
  setTimeout(() => {
    if (elem) {
      import_xe_utils.default.arrayEach(elem.querySelectorAll(`.vxe-table--column.${colMoveClass}`), (elem2) => removeClass(elem2, colMoveClass));
    }
  }, 500);
}

// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/src/body.js
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/src/header.js
  ...
  setup(props) {
    ...
    const renderRows = (isGroup, isOptimizeMode, cols, $rowIndex) => {
      ...
      return cols.map((column, $columnIndex) => {
        ...
        ], style: headerCellStyle ? import_xe_utils3.default.isFunction(headerCellStyle) ? headerCellStyle(cellParams) : headerCellStyle : null }, thAttrs), thOns), { key: columnKey || scrollXLoad || scrollYLoad || columnOpts.useKey || columnOpts.drag || isColGroup ? colid : $columnIndex }), [
          h("div", {
            class: ["vxe-cell", {
              "c--title": showTitle,
              "c--tooltip": showTooltip,
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/src/footer.js
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/src/props.js
var { getConfig } = VxeUI;
var props_default = {
  /** 基本属性 */
  id: [String, Function],
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/src/emits.js
var emits_default = [
  "update:data",
  "keydown-start",
  "keydown",
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/module/custom/panel.js
...
var panel_default = defineVxeComponent({
  ...
  setup(props, context) {
    ...
    const renderSimplePanel = () => {
      ...
      const { customStore } = props;
      const { treeConfig, rowGroupConfig, aggregateConfig } = tableProps2;
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/module/filter/panel.js
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/module/export/import-panel.js
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/module/export/export-panel.js
...
// ../../node_modules/.pnpm/vxe-table@4.14.4_vue@3.5.17_typescript@5.8.3_/node_modules/vxe-table/es/table/module/menu/panel.js
...
var table_default = defineVxeComponent({
  ...
  setup(props, context) {
    ...
    const browseObj = import_xe_utils10.default.browse();
    ...
    const computeTableId = computed(() => {
      const { id } = props;
      if (id) {
        if (import_xe_utils10.default.isFunction(id)) {
    ...
    const computeScrollXThreshold = computed(() => {
      ...
      if (threshold) {
        return import_xe_utils10.default.toNumber(threshold);
      }
      return 0;
    });
    ...
    const computeVirtualXOpts = computed(() => {
      return Object.assign({}, getConfig2().table.virtualXConfig || getConfig2().table.scrollX, props.virtualXConfig || props.scrollX);
    });
    const computeVirtualYOpts = computed(() => {
      return Object.assign({}, getConfig2().table.virtualYConfig || getConfig2().table.scrollY, props.virtualYConfig || props.scrollY);
    });
    ...
    const computeCellOpts = computed(() => {
      ...
      if (cellOpts.height) {
        cellOpts.height = import_xe_utils10.default.toNumber(cellOpts.height);
      }
      return cellOpts;
    });
    const computeHeaderCellOpts = computed(() => {
      ...
      const cellOpts = computeCellOpts.value;
      headerCellOpts.height = import_xe_utils10.default.toNumber(getCalcHeight(headerCellOpts.height || cellOpts.height));
    ...
    const computeFooterCellOpts = computed(() => {
      ...
      const cellOpts = computeCellOpts.value;
      footerCellOpts.height = import_xe_utils10.default.toNumber(getCalcHeight(footerCellOpts.height || cellOpts.height));
    ...
    const computeAggregateOpts = computed(() => {
      return Object.assign({}, getConfig2().table.aggregateConfig || getConfig2().table.rowGroupConfig, props.aggregateConfig || props.rowGroupConfig);
    });
    ...
    const computeTableRowExpandedList = computed(() => {
      ...
      if (tableData.length && expandColumn && rowExpandedFlag && rowGroupExpandedFlag && treeExpandedFlag) {
        import_xe_utils10.default.each(rowExpandedMaps, (row, rowid) => {
    ...
    const eqCellValue = (row1, row2, field) => {
      const val1 = import_xe_utils10.default.get(row1, field);
      const val2 = import_xe_utils10.default.get(row2, field);
      if (eqEmptyValue(val1) && eqEmptyValue(val2)) {
        return true;
      }
      if (import_xe_utils10.default.isString(val1) || import_xe_utils10.default.isNumber(val1)) {
        return "" + val1 === "" + val2;
      }
      return import_xe_utils10.default.isEqual(val1, val2);
    };
    ...
    const hangleStorageDefaultValue = (value, isAll) => {
      return import_xe_utils10.default.isBoolean(value) ? value : isAll;
    };
    ...
    const getCustomStorageMap = (id) => {
      ...
      const rest = import_xe_utils10.default.toStringJSON(localStorage.getItem(customStorageKey) || "");
    ...
    const setCustomStorageMap = (id, data) => {
      ...
      maps[id] = data || void 0;
      maps._v = version;
      localStorage.setItem(customStorageKey, import_xe_utils10.default.toJSONString(maps));
    };
    const getRecoverRowMaps = (keyMaps) => {
      const { fullAllDataRowIdData } = internalData;
      const restKeys = {};
      import_xe_utils10.default.each(keyMaps, (row, rowid) => {
    ...
    const handleReserveRow = (reserveRowMap) => {
      ...
      const reserveList = [];
      import_xe_utils10.default.each(reserveRowMap, (item, rowid) => {
    ...
    const handleBodyMerge = (merges) => {
      ...
      if (merges) {
        const { handleGetRowId } = createHandleGetRowId($xeTable);
        if (!import_xe_utils10.default.isArray(merges)) {
          merges = [merges];
        }
        merges.forEach((item) => {
          ...
          if (import_xe_utils10.default.isNumber(margeRow)) {
          ...
          if (import_xe_utils10.default.isNumber(margeCol)) {
          ...
          if (mergeRowIndex > -1 && mergeColumnIndex > -1 && (rowspan || colspan)) {
            rowspan = import_xe_utils10.default.toNumber(rowspan) || 1;
            colspan = import_xe_utils10.default.toNumber(colspan) || 1;
    ...
    const handleFooterMerge = (merges) => {
      ...
      if (merges) {
        ...
        merges.forEach((item) => {
          let { row: margeRow, col: margeCol, rowspan, colspan } = item;
          const mergeRowIndex = import_xe_utils10.default.isNumber(margeRow) ? margeRow : -1;
          let mergeColumnIndex = -1;
          if (import_xe_utils10.default.isNumber(margeCol)) {
            mergeColumnIndex = margeCol;
          } else {
    ...
    const removeBodyMerges = (merges) => {
      ...
      if (merges) {
        ...
        merges.forEach((item) => {
          ...
          const mcIndex = import_xe_utils10.default.findIndexOf(mergeBodyList, (item2) => item2.row === mergeRowIndex && item2.col === mergeColumnIndex);
          if (mcIndex > -1) {
    ...
    const removeFooterMerges = (merges) => {
      ...
      if (merges) {
        ...
        merges.forEach((item) => {
          ...
          const mcIndex = import_xe_utils10.default.findIndexOf(mergeFooterList, (item2) => item2.row === mergeRowIndex && item2.col === mergeColumnIndex);
          if (mcIndex > -1) {
    ...
    const handleSortEvent = (evnt, sortConfs, isUpdate) => {
      ...
      if (!import_xe_utils10.default.isArray(sortConfs)) {
        sortConfs = [sortConfs];
      }
      if (sortConfs && sortConfs.length) {
        ...
        sortConfs.forEach((confs, index) => {
          ...
          let column = field;
          if (import_xe_utils10.default.isString(field)) {
    ...
    const calcTableHeight = (key) => {
      ...
      if (val) {
        if (val === "100%" || val === "auto") {
          ...
          if (isScale(val)) {
            num = Math.floor((import_xe_utils10.default.toInteger(val) || 1) / 100 * parentHeight);
          } else {
            num = import_xe_utils10.default.toNumber(val);
          }
    ...
    const handleCustomRestore = (storeData) => {
      ...
      if (resizableData || sortData || visibleData || fixedData) {
        import_xe_utils10.default.eachTree(collectColumn, (column, index, items, path, parentColumn) => {
          const colKey = column.getKey();
          if (!parentColumn) {
            if (fixedData && fixedData[colKey] !== void 0) {
              column.fixed = fixedData[colKey];
            }
            if (sortData && import_xe_utils10.default.isNumber(sortData[colKey])) {
              hasCustomSort = true;
              column.renderSortNumber = sortData[colKey];
            }
          }
          if (resizableData && import_xe_utils10.default.isNumber(resizableData[colKey])) {
            column.resizeWidth = resizableData[colKey];
          }
          if (visibleData && import_xe_utils10.default.isBoolean(visibleData[colKey])) {
            column.visible = visibleData[colKey];
          }
        });
        if (hasCustomSort) {
          collectColumn = import_xe_utils10.default.orderBy(collectColumn, "renderSortNumber");
    ...
    const cacheColumnMap = () => {
      ...
      if (isGroup) {
        import_xe_utils10.default.eachTree(collectColumn, (column, index, items, path, parentColumn, nodes) => {
    ...
    const calcColumnAutoWidth = (column, wrapperEl) => {
      ...
      if (firstCellEl && firstCellEl.parentElement) {
        ...
        leftRightPadding = Math.ceil(import_xe_utils10.default.toNumber(cellStyle.paddingLeft) + import_xe_utils10.default.toNumber(cellStyle.paddingRight));
      }
    ...
    const autoCellWidth = () => {
      ...
      pxMinList.forEach((column) => {
        const minWidth = import_xe_utils10.default.toInteger(column.minWidth);
        tWidth += minWidth;
        column.renderWidth = minWidth;
      });
      autoMinList.forEach((column) => {
        const caWidth = Math.max(60, import_xe_utils10.default.toInteger(column.renderAutoWidth));
        tWidth += caWidth;
        column.renderWidth = caWidth;
      });
      scaleMinList.forEach((column) => {
        const smWidth = Math.floor(import_xe_utils10.default.toInteger(column.minWidth) * meanWidth);
        tWidth += smWidth;
        column.renderWidth = smWidth;
      });
      scaleList.forEach((column) => {
        const sfWidth = Math.floor(import_xe_utils10.default.toInteger(column.width) * meanWidth);
        tWidth += sfWidth;
        column.renderWidth = sfWidth;
      });
      pxList.forEach((column) => {
        const pWidth = import_xe_utils10.default.toInteger(column.width);
        tWidth += pWidth;
        column.renderWidth = pWidth;
      });
      autoList.forEach((column) => {
        const aWidth = Math.max(60, import_xe_utils10.default.toInteger(column.renderAutoWidth));
        tWidth += aWidth;
        column.renderWidth = aWidth;
      });
      resizeList.forEach((column) => {
        const reWidth = import_xe_utils10.default.toInteger(column.resizeWidth);
        tWidth += reWidth;
    ...
    const calcCellAutoHeight = (rowRest, wrapperEl) => {
      ...
      for (let i = 0; i < cellElemList.length; i++) {
        ...
        const topBottomPadding = Math.ceil(import_xe_utils10.default.toNumber(tdEl.style.paddingTop) + import_xe_utils10.default.toNumber(tdEl.style.paddingBottom));
    ...
    const getOrderField = (column) => {
      ...
      return (row) => {
        let cellValue;
        if (sortBy) {
          cellValue = import_xe_utils10.default.isFunction(sortBy) ? sortBy({ row, column }) : import_xe_utils10.default.get(row, sortBy);
        } else {
          cellValue = tableMethods.getCellLabel(row, column);
        }
        if (!sortType || sortType === "auto") {
          return isNaN(cellValue) ? cellValue : import_xe_utils10.default.toNumber(cellValue);
        } else if (sortType === "number") {
          return import_xe_utils10.default.toNumber(cellValue);
        } else if (sortType === "string") {
          return import_xe_utils10.default.toValueString(cellValue);
        }
        return cellValue;
      };
    };
    ...
    const updateAfterDataIndex = () => {
      ...
      if (treeConfig) {
        const { handleGetRowId } = createHandleGetRowId($xeTable);
        import_xe_utils10.default.eachTree(afterTreeFullData, (row, index, items, path) => {
          const rowid = handleGetRowId(row);
          const rowRest = fullAllDataRowIdData[rowid];
    ...
    const handleVirtualTreeToList = () => {
      ...
      if (treeConfig && treeOpts.transform) {
        const childrenField = treeOpts.children || treeOpts.childrenField;
        import_xe_utils10.default.eachTree(internalData.afterTreeFullData, (row, index, items, path, parentRow) => {
          const rowid = handleGetRowId(row);
        ...
        import_xe_utils10.default.eachTree(internalData.afterGroupFullData, (row, index, items, path, parentRow) => {
          const rowid = handleGetRowId(row);
          const parentRowid = handleGetRowId(parentRow);
    ...
    const updateAfterFullData = () => {
      ...
      if (!allRemoteFilter || !allRemoteSort) {
        ...
        if (sortMultiple && chronological && orderColumns.length > 1) {
          orderColumns = import_xe_utils10.default.orderBy(orderColumns, "sortTime");
        }
        if (!allRemoteFilter && filterColumns.length) {
          const handleFilter = (row) => {
            return filterColumns.every(({ column, valueList, itemList }) => {
              ...
              return valueList.indexOf(import_xe_utils10.default.get(row, column.field)) > -1;
            });
          };
          if (isRowGroupStatus) {
            tableTree = import_xe_utils10.default.searchTree(tableFullGroupData, handleFilter, {
              original: true,
              isEvery: true,
            ...
            tableTree = import_xe_utils10.default.searchTree(tableFullTreeData, handleFilter, {
              original: true,
              isEvery,
          ...
          if (isRowGroupStatus) {
            tableTree = import_xe_utils10.default.searchTree(tableFullGroupData, () => true, {
              original: true,
              isEvery: true,
              children: aggregateOpts.mapChildrenField,
              mapChildren: aggregateOpts.childrenField
            ...
            tableTree = import_xe_utils10.default.searchTree(tableFullTreeData, () => true, {
              original: true,
              isEvery,
              children: mapChildrenField,
              mapChildren: childrenField
        ...
        if (!allRemoteSort && orderColumns.length) {
          if (isRowGroupStatus) {
            if (allSortMethod) {
              ...
              tableTree = import_xe_utils10.default.isArray(sortRests) ? sortRests : tableTree;
            } else {
              const treeList = import_xe_utils10.default.toTreeArray(tableTree, {
                key: aggregateOpts.rowField,
                parentKey: aggregateOpts.parentField,
                children: aggregateOpts.mapChildrenField
              });
              tableTree = import_xe_utils10.default.toArrayTree(import_xe_utils10.default.orderBy(treeList, orderColumns.map(({ column, order }) => [getOrderField(column), order])), {
                key: aggregateOpts.rowField,
                parentKey: aggregateOpts.parentField,
            ...
            if (allSortMethod) {
              ...
              tableData = import_xe_utils10.default.isArray(sortRests) ? sortRests : tableData;
            } else {
              tableData = import_xe_utils10.default.orderBy(tableData, orderColumns.map(({ column, order }) => [getOrderField(column), order]));
            }
            tableTree = tableData;
          }
        }
    ...
    const handleDefaultSort = () => {
      ...
      if (sortConfig) {
        ...
        if (defaultSort) {
          if (!import_xe_utils10.default.isArray(defaultSort)) {
    ...
    const handleCheckedCheckboxRow = (rows, value, isForce) => {
      if (rows && !import_xe_utils10.default.isArray(rows)) {
        rows = [rows];
      }
    ...
    const handleCheckedAllCheckboxRow = (checked, isForce) => {
      ...
      if (checkField) {
        const checkValFn = (row) => {
          if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
            ...
            import_xe_utils10.default.set(row, checkField, checked);
          }
          if ((treeConfig || isRowGroupStatus) && indeterminateField) {
            import_xe_utils10.default.set(row, indeterminateField, false);
          }
        };
        if (treeConfig || isRowGroupStatus) {
          import_xe_utils10.default.eachTree(afterFullData, checkValFn, { children: childrenField });
        } else {
        ...
        if (isRowGroupStatus) {
          if (checked) {
            import_xe_utils10.default.eachTree(afterGroupFullData, (row) => {
              if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
                const rowid = handleGetRowId(row);
          ...
          if (checked) {
            import_xe_utils10.default.eachTree(afterTreeFullData, (row) => {
              if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
                const rowid = handleGetRowId(row);
                selectRowMaps[rowid] = row;
              }
      ...
      if (reserve) {
        if (checked) {
          import_xe_utils10.default.each(selectRowMaps, (row, rowid) => {
            checkboxReserveRowMap[rowid] = row;
          });
        } else {
    ...
    const handleDefaultTreeExpand = () => {
      ...
      if (treeConfig) {
        ...
        if (expandAll) {
          ...
          const rowkey = getRowkey($xeTable);
          expandRowKeys.forEach((rowid) => {
            const matchObj = import_xe_utils10.default.findTree(tableFullData, (item) => rowid === import_xe_utils10.default.get(item, rowkey), { children: childrenField });
            if (matchObj) {
      ...
      return new Promise((resolve) => {
        if (loadMethod) {
          ...
          Promise.resolve(loadMethod({ $table: $xeTable, row })).then((childRecords) => {
            ...
            if (!import_xe_utils10.default.isArray(childRecords)) {
              childRecords = [];
            }
            if (childRecords) {
    ...
    const computeScrollLoad = () => {
      return nextTick().then(() => {
        ...
        if (scrollXLoad) {
          ...
          const offsetXSize = Math.max(0, virtualXOpts.oSize ? import_xe_utils10.default.toNumber(virtualXOpts.oSize) : 0);
          scrollXStore.preloadSize = import_xe_utils10.default.toNumber(virtualXOpts.preSize);
        ...
        if (scrollYLoad) {
          const offsetYSize = Math.max(0, virtualYOpts.oSize ? import_xe_utils10.default.toNumber(virtualYOpts.oSize) : 0);
          scrollYStore.preloadSize = import_xe_utils10.default.toNumber(virtualYOpts.preSize);
    ...
    const handleUpdateRowGroup = (groupFields) => {
      ...
      const aggConfs = [];
      if (groupFields) {
        (import_xe_utils10.default.isArray(groupFields) ? groupFields : [groupFields]).forEach((field) => {
    ...
    const handleeGroupSummary = (aggList) => {
      ...
      if (mapChildrenField) {
        import_xe_utils10.default.lastEach(aggList, (aggRow) => {
          let count = 0;
          import_xe_utils10.default.each(aggRow[mapChildrenField], (row) => {
            if (row.isAggregate) {
    ...
    const updateGroupData = () => {
      ...
      if ((aggregateConfig || rowGroupConfig) && isRowGroupStatus) {
        const aggList = [];
        import_xe_utils10.default.eachTree(tableFullGroupData, (row) => {
          if (row.isAggregate) {
            aggList.push(row);
          }
        }, { children: mapChildrenField });
    ...
    const handleGroupData = (list, rowGroups) => {
      ...
      if (rowGroups) {
        ...
        if (rgItem && rowField && parentField && childrenField && mapChildrenField) {
          ...
          const rowkey = getRowkey($xeTable);
          list.forEach((row) => {
            const cellValue = groupColumn ? $xeTable.getCellLabel(row, groupColumn) : import_xe_utils10.default.get(row, groupField);
            const groupValue = import_xe_utils10.default.eqNull(cellValue) ? "" : cellValue;
          ...
          import_xe_utils10.default.objectEach(groupMaps, (childList, groupValue) => {
    ...
    const loadTableData = (datas, isReset) => {
      ...
      if (treeConfig) {
        if (transform) {
          ...
          treeData = import_xe_utils10.default.toArrayTree(fullData, {
    ...
    const handleUpdateColumn = () => {
      const columnList = import_xe_utils10.default.orderBy(internalData.collectColumn, "renderSortNumber");
    ...
    const parseColumns = (isReset) => {
      ...
      if (isGroup) {
        ...
        import_xe_utils10.default.eachTree(collectColumn, (column, index, items, path, parentColumn) => {
          ...
          if (isColGroup) {
            column.visible = !!import_xe_utils10.default.findTree(column.children, (subColumn) => hasChildrenList(subColumn) ? false : subColumn.visible);
    ...
    const handleBaseTreeExpand = (rows, expanded) => {
      ...
      if (accordion) {
        ...
        const matchObj = import_xe_utils10.default.findTree(tableFullTreeData, (item) => item === validRows[0], { children: childrenField });
        if (matchObj) {
    ...
    const handleRowGroupBaseExpand = (rows, expanded) => {
      ...
      if (mapChildrenField) {
        if (accordion) {
          validRows = validRows.length ? [validRows[validRows.length - 1]] : [];
          const matchObj = import_xe_utils10.default.findTree(tableFullGroupData, (item) => getRowid($xeTable, item) === getRowid($xeTable, validRows[0]), { children: mapChildrenField });
          if (matchObj) {
            matchObj.items.forEach((item) => {
              const rowid = handleGetRowId(item);
    ...
    const updateRowExpandStyle = () => {
      ...
      if (expandColumn && mode === "fixed") {
        ...
        if (rowExpandEl && bodyScrollElem) {
          ...
          import_xe_utils10.default.arrayEach(rowExpandEl.children, (reEl) => {
            const expandEl = reEl;
    ...
    tableMethods = {
      ...
      setRow(rows, record) {
        if (rows && record) {
          let rest = rows;
          if (!import_xe_utils10.default.isArray(rows)) {
            rest = [rows];
          }
          const rowkey = getRowkey($xeTable);
          rest.forEach((row) => {
            const rowid = getRowid($xeTable, row);
            const newRecord = import_xe_utils10.default.clone(Object.assign({}, record), true);
            import_xe_utils10.default.set(newRecord, rowkey, rowid);
      ...
      reloadRow(row, record, field) {
        ...
        if (keepSource) {
          ...
          if (oRow && row) {
            if (field) {
              const newValue = import_xe_utils10.default.clone(import_xe_utils10.default.get(record || row, field), true);
              import_xe_utils10.default.set(row, field, newValue);
              import_xe_utils10.default.set(oRow, field, newValue);
            } else {
              const rowkey = getRowkey($xeTable);
              const rowid = getRowid($xeTable, row);
              const newRecord = import_xe_utils10.default.clone(Object.assign({}, record), true);
              import_xe_utils10.default.set(newRecord, rowkey, rowid);
              import_xe_utils10.default.destructuring(oRow, Object.assign(row, newRecord));
            }
          }
      ...
      loadTreeChildren(row, childRecords) {
        ...
        return tableMethods.createData(childRecords).then((rows) => {
          if (keepSource) {
            const rowid = getRowid($xeTable, row);
            const matchObj = import_xe_utils10.default.findTree(tableSourceData, (item) => rowid === getRowid($xeTable, item), { children: childrenField });
            if (matchObj) {
              matchObj.item[childrenField] = import_xe_utils10.default.clone(rows, true);
            }
            rows.forEach((childRow) => {
              const rowid2 = getRowid($xeTable, childRow);
              sourceDataRowIdData[rowid2] = import_xe_utils10.default.clone(childRow, true);
            });
          }
          import_xe_utils10.default.eachTree(rows, (childRow, index, items, path, parentItem, nodes) => {
          ...
          if (transform) {
            row[mapChildrenField] = import_xe_utils10.default.clone(rows, false);
          }
          updateAfterDataIndex();
          return rows;
        });
      ...
      loadColumn(columns) {
        ...
        const collectColumn = import_xe_utils10.default.mapTree(columns, (column) => reactive(cell_default.createColumn($xeTable, column)));
       ...
       */
      createRow(records) {
        const isArr = import_xe_utils10.default.isArray(records);
        if (!isArr) {
          records = [records || {}];
        }
      ...
      revertData(rows, field) {
        ...
        if (rows) {
          ...
          targetRows = import_xe_utils10.default.toArray($xeTable.getUpdateRecords());
        }
        let reDelFlag = false;
          ...
          targetRows.forEach((item) => {
            ...
            if (rowRest) {
              ...
              if (!$xeTable.isInsertByRow(row)) {
                ...
                if (oRow && row) {
                  if (field) {
                    import_xe_utils10.default.set(row, field, import_xe_utils10.default.clone(import_xe_utils10.default.get(oRow, field), true));
                  } else {
                    import_xe_utils10.default.destructuring(row, import_xe_utils10.default.clone(oRow, true));
                  }
      ...
      clearData(rows, field) {
        ...
        if (!arguments.length) {
          rows = tableFullData;
        } else if (rows && !import_xe_utils10.default.isArray(rows)) {
          rows = [rows];
        }
        if (field) {
          rows.forEach((row) => import_xe_utils10.default.set(row, field, null));
        } else {
          rows.forEach((row) => {
            visibleColumn.forEach((column) => {
              if (column.field) {
      ...
      getCellLabel(row, fieldOrColumn) {
        ...
        if (formatter) {
          ...
          if (import_xe_utils10.default.isString(formatter)) {
            const gFormatOpts = formats.get(formatter);
            const tcFormatMethod = gFormatOpts ? gFormatOpts.tableCellFormatMethod || gFormatOpts.cellFormatMethod : null;
            cellLabel = tcFormatMethod ? tcFormatMethod(formatParams) : "";
          } else if (import_xe_utils10.default.isArray(formatter)) {
      ...
      removeInsertRow() {
        ...
        return $xeTable.remove(import_xe_utils10.default.values(insertRowMaps));
      },
      /**
       * 检查行或列数据是否发生改变
       */
      isUpdateByRow(rowidOrRow, field) {
        ...
        if (keepSource) {
          const rowid = import_xe_utils10.default.isString(rowidOrRow) || import_xe_utils10.default.isNumber(rowidOrRow) ? rowidOrRow : getRowid($xeTable, rowidOrRow);
      ...
      getColumns(columnIndex) {
        const { visibleColumn } = internalData;
        return import_xe_utils10.default.isUndefined(columnIndex) ? visibleColumn.slice(0) : visibleColumn[columnIndex];
      },
      /**
       * 根据列获取列的唯一主键
       */
      ...
      moveColumnTo(fieldOrColumn, targetFieldOrColumn, options) {
        ...
        let defPos = "left";
        if (import_xe_utils10.default.isNumber(targetFieldOrColumn)) {
      ...
      moveRowTo(rowidOrRow, targetRowidOrRow, options) {
        ...
        if (import_xe_utils10.default.isNumber(targetRowidOrRow)) {
      ...
      getData(rowIndex) {
        ...
        return import_xe_utils10.default.isUndefined(rowIndex) ? tableSynchData.slice(0) : tableSynchData[rowIndex];
      },
      /**
       * 用于多选行，获取已选中的数据
       */
        ...
        if (updateCheckboxFlag) {
          if (checkField) {
            if (treeConfig) {
              ...
              rowList = import_xe_utils10.default.filterTree(currTableData, (row) => import_xe_utils10.default.get(row, checkField), { children: transform ? mapChildrenField : childrenField });
            } else {
              const currTableData = isFull ? tableFullData : afterFullData;
              rowList = currTableData.filter((row) => import_xe_utils10.default.get(row, checkField));
            }
          } else {
            const currMaps = isFull || treeConfig && !transform ? fullDataRowIdData : afterFullRowMaps;
            import_xe_utils10.default.each(selectCheckboxMaps, (row, rowid) => {
              if (currMaps[rowid]) {
      ...
      getTreeRowChildren(rowOrRowid) {
        ...
        if (rowOrRowid && treeConfig) {
          let rowid;
          if (import_xe_utils10.default.isString(rowOrRowid)) {
            rowid = rowOrRowid;
          } else {
      ...
      getRowById(cellValue) {
        const { fullAllDataRowIdData } = internalData;
        const rowid = import_xe_utils10.default.eqNull(cellValue) ? "" : encodeURIComponent(cellValue || "");
      ...
      getFullData() {
        ...
        if (treeConfig) {
          ...
          const childrenField = treeOpts.children || treeOpts.childrenField;
          if (transform) {
            return import_xe_utils10.default.toArrayTree(import_xe_utils10.default.toTreeArray(tableFullTreeData, {
              children: mapChildrenField
            }), {
              key: rowField,
              parentKey: parentField,
      ...
      setColumnFixed(fieldOrColumn, fixed) {
        let status = false;
        const cols = import_xe_utils10.default.isArray(fieldOrColumn) ? fieldOrColumn : [fieldOrColumn];
        const columnOpts = computeColumnOpts.value;
        const isMaxFixedColumn = computeIsMaxFixedColumn.value;
        for (let i = 0; i < cols.length; i++) {
          ...
          if (targetColumn && targetColumn.fixed !== fixed) {
            ...
            import_xe_utils10.default.eachTree([targetColumn], (column2) => {
              column2.fixed = fixed;
      ...
      setColumnWidth(fieldOrColumn, width) {
        ...
        let status = false;
        const cols = import_xe_utils10.default.isArray(fieldOrColumn) ? fieldOrColumn : [fieldOrColumn];
        let cWidth = import_xe_utils10.default.toInteger(width);
        if (isScale(width)) {
          const bodyScrollElem = getRefElem(elemStore["main-body-scroll"]);
      ...
      setRowHeightConf(heightConf) {
        ...
        let status = false;
        if (heightConf) {
          import_xe_utils10.default.each(heightConf, (height, rowid) => {
            const rowRest = fullAllDataRowIdData[rowid];
            if (rowRest) {
              const rHeight = import_xe_utils10.default.toInteger(height);
              if (rHeight) {
      ...
      setRowHeight(rowOrId, height) {
        const { fullAllDataRowIdData } = internalData;
        let status = false;
        const rows = import_xe_utils10.default.isArray(rowOrId) ? rowOrId : [rowOrId];
        let rHeight = import_xe_utils10.default.toInteger(height);
        if (isScale(height)) {
          const tableBody = refTableBody.value;
        ...
        if (rHeight) {
          const { handleGetRowId } = createHandleGetRowId($xeTable);
          rows.forEach((row) => {
            const rowid = import_xe_utils10.default.isString(row) || import_xe_utils10.default.isNumber(row) ? row : handleGetRowId(row);
            const rowRest = fullAllDataRowIdData[rowid];
            if (rowRest) {
              rowRest.resizeHeight = rHeight;
              if (!status) {
      ...
      getRowHeight(rowOrId) {
        ...
        const cellOpts = computeCellOpts.value;
        const defaultRowHeight = computeDefaultRowHeight.value;
        const rowid = import_xe_utils10.default.isString(rowOrId) || import_xe_utils10.default.isNumber(rowOrId) ? rowOrId : getRowid($xeTable, rowOrId);
        const rowRest = fullAllDataRowIdData[rowid];
        if (rowRest) {
      ...
      getCheckboxIndeterminateRecords(isFull) {
        ...
        if (treeConfig) {
          const fullRest = [];
          const defRest = [];
          import_xe_utils10.default.each(treeIndeterminateRowMaps, (item, rowid) => {
            if (item) {
              fullRest.push(item);
              if (fullDataRowIdData[rowid]) {
                defRest.push(item);
      ...
      setCheckboxRowKey(keys, checked) {
        const { fullAllDataRowIdData } = internalData;
        if (!import_xe_utils10.default.isArray(keys)) {
          keys = [keys];
        }
        const rows = [];
        keys.forEach((rowid) => {
      ...
      isCheckedByCheckboxRow(row) {
        ...
        const { checkField } = checkboxOpts;
        if (checkField) {
          return import_xe_utils10.default.get(row, checkField);
        }
      ...
      isCheckedByCheckboxRowKey(rowid) {
        ...
        if (checkField) {
          const rowRest = fullAllDataRowIdData[rowid];
          if (rowRest) {
            return import_xe_utils10.default.get(rowRest.row, checkField);
          }
          return false;
        }
      ...
      toggleCheckboxRow(row) {
        ...
        const checkboxOpts = computeCheckboxOpts.value;
        const { checkField } = checkboxOpts;
        const checked = checkField ? !import_xe_utils10.default.get(row, checkField) : !selectCheckboxMaps[getRowid($xeTable, row)];
      ...
      getRadioReserveRecord(isFull) {
        ...
        if (radioOpts.reserve && radioReserveRow) {
          ...
          if (isFull) {
            ...
            const rowkey = getRowkey($xeTable);
            if (treeConfig) {
              const matchObj = import_xe_utils10.default.findTree(afterFullData, (row) => rowid === import_xe_utils10.default.get(row, rowkey), { children: childrenField });
              if (matchObj) {
                return radioReserveRow;
              }
            } else {
              if (!afterFullData.some((row) => rowid === import_xe_utils10.default.get(row, rowkey))) {
                return radioReserveRow;
              }
            }
          }
      ...
      getCheckboxReserveRecords(isFull) {
        ...
        if (checkboxOpts.reserve) {
          ...
          if (treeConfig) {
            import_xe_utils10.default.eachTree(afterFullData, (row) => {
          ...
          import_xe_utils10.default.each(checkboxReserveRowMap, (oldRow, oldRowid) => {
            if (oldRow) {
              if (isFull) {
        ...
        if (checkField) {
          const handleClearChecked = (item) => {
            if (treeConfig && indeterminateField) {
              import_xe_utils10.default.set(item, indeterminateField, false);
            }
            import_xe_utils10.default.set(item, checkField, false);
          };
          if (treeConfig) {
            import_xe_utils10.default.eachTree(tableFullData, handleClearChecked, { children: childrenField });
          } else {
      ...
      setCurrentRow(row) {
        ...
        if (rowOpts.isCurrent || props.highlightCurrentRow) {
          if (el) {
            import_xe_utils10.default.arrayEach(el.querySelectorAll(`[rowid="${getRowid($xeTable, row)}"]`), (elem) => addClass(elem, "row--current"));
          }
        }
        return nextTick();
      },
      ...
      clearCurrentRow() {
        ...
        if (el) {
          import_xe_utils10.default.arrayEach(el.querySelectorAll(".row--current"), (elem) => removeClass(elem, "row--current"));
        }
        return nextTick();
      },
      /**
      ...
      getPendingRecords() {
        ...
        const insertRecords = [];
        import_xe_utils10.default.each(pendingRowMaps, (row, rowid) => {
          if (fullAllDataRowIdData[rowid]) {
      ...
      sort(sortConfs, sortOrder) {
        ...
        const { multiple, remote, orders } = sortOpts;
        if (sortConfs) {
          if (import_xe_utils10.default.isString(sortConfs)) {
            sortConfs = [
      ...
      getSortColumns() {
        ...
        if (multiple && chronological && sortList.length > 1) {
          return import_xe_utils10.default.orderBy(sortList, "sortTime");
        }
        return sortList;
      },
      ...
      setAllRowExpand(expanded) {
        ...
        let expandedRows = [];
        if (props.treeConfig) {
          import_xe_utils10.default.eachTree(tableFullTreeData, (row) => {
      ...
      getRowExpandRecords() {
        const rest = [];
        import_xe_utils10.default.each(internalData.rowExpandedMaps, (item) => {
          if (item) {
            rest.push(item);
          }
        });
      ...
      setRowGroups(fieldOrColumns) {
        ...
        const confList = fieldOrColumns ? import_xe_utils10.default.isArray(fieldOrColumns) ? fieldOrColumns : [fieldOrColumns] : [];
        if (maxGroupSize && confList.length > maxGroupSize) {
          if (VxeUI.modal) {
            VxeUI.modal.message({
              status: "error",
              content: getI18n6("vxe.table.maxGroupCol", [maxGroupSize])
            });
          }
          return nextTick();
        }
        if (confList.length) {
          handleUpdateRowGroup(confList.map((fieldOrColumn) => {
            return import_xe_utils10.default.isString(fieldOrColumn) ? fieldOrColumn : fieldOrColumn.field;
          }));
      ...
      getTreeExpandRecords() {
        const rest = [];
        import_xe_utils10.default.each(internalData.treeExpandedMaps, (item) => {
          if (item) {
            rest.push(item);
          }
        });
      ...
      clearTreeExpandLoaded(rows) {
        ...
        if (rows) {
          ...
          import_xe_utils10.default.each(fullAllDataRowIdData, (rowRest) => {
            rowRest.treeLoaded = false;
          });
        }
      ...
      setAllTreeExpand(expanded) {
        ...
        const childrenField = treeOpts.children || treeOpts.childrenField;
        const expandeds = [];
        import_xe_utils10.default.eachTree(tableFullData, (row) => {
      ...
      clearTreeExpand() {
        ...
        internalData.treeExpandedMaps = {};
        if (reserve) {
          import_xe_utils10.default.eachTree(tableFullTreeData, (row) => handleTreeExpandReserve(row, false), { children: childrenField });
        }
      ...
      scrollTo(scrollLeft, scrollTop) {
        ...
        const yHandleEl = refScrollYHandleElem.value;
        internalData.intoRunScroll = true;
        if (import_xe_utils10.default.isNumber(scrollLeft)) {
        ...
        if (import_xe_utils10.default.isNumber(scrollTop)) {
      ...
      if (internalData.isActivated) {
        $xeTable.preventEvent(evnt, "event.keydown", null, () => {
          ...
          if (operCtxMenu) {
            ...
            const { parent: parentRow } = import_xe_utils10.default.findTree(internalData.afterTreeFullData, (item) => item === currentRow, { children: childrenField });
            if (parentRow) {
              evnt.preventDefault();
              const params = {
                row: parentRow,
    ...
    const clearRowDropOrigin = () => {
      ...
      if (el) {
        ...
        import_xe_utils10.default.arrayEach(el.querySelectorAll(`.${clss}`), (elem) => {
    ...
    const updateRowDropOrigin = (row) => {
      ...
      if (el) {
        const clss = "row--drag-origin";
        const rowid = getRowid($xeTable, row);
        import_xe_utils10.default.arrayEach(el.querySelectorAll(`[rowid="${rowid}"]`), (elem) => {
          addClass(elem, clss);
        });
      }
    };
    ...
    const updateColDropOrigin = (column) => {
      ...
      if (el) {
        ...
        import_xe_utils10.default.arrayEach(el.querySelectorAll(colQuerys.join(",")), (elem) => {
          addClass(elem, clss);
        });
      }
    };
    ...
    const handleTooltip = (evnt, tdEl, overflowElem, tipElem, params) => {
      ...
      const useCustom = contentMethod && !import_xe_utils10.default.eqNull(customContent);
      const content = useCustom ? customContent : import_xe_utils10.default.toString(column.type === "html" ? tipOverEl.innerText : tipOverEl.textContent).trim();
    ...
    const callSlot = (slotFunc, params) => {
      if (slotFunc) {
        ...
        if (import_xe_utils10.default.isFunction(slotFunc)) {
    ...
    tablePrivateMethods = {
      ...
      defineField(records) {
        ...
        const childrenField = treeOpts.children || treeOpts.childrenField;
        const rowkey = getRowkey($xeTable);
        if (!import_xe_utils10.default.isArray(records)) {
          records = [records];
        }
        return records.map((record) => {
          internalData.tableFullColumn.forEach((column) => {
            const { field, editRender } = column;
            if (field && !import_xe_utils10.default.has(record, field) && !record[field]) {
              let cellValue = null;
              if (editRender) {
                const { defaultValue } = editRender;
                if (import_xe_utils10.default.isFunction(defaultValue)) {
                  cellValue = defaultValue({ column });
                } else if (!import_xe_utils10.default.isUndefined(defaultValue)) {
                  cellValue = defaultValue;
                }
              }
              import_xe_utils10.default.set(record, field, cellValue);
            }
          });
          const otherFields = [radioOpts.labelField, checkboxOpts.checkField, checkboxOpts.labelField, expandOpts.labelField];
          otherFields.forEach((key) => {
            if (key && eqEmptyValue(import_xe_utils10.default.get(record, key))) {
              import_xe_utils10.default.set(record, key, null);
            }
          });
          if (treeConfig && treeOpts.lazy && import_xe_utils10.default.isUndefined(record[childrenField])) {
            record[childrenField] = null;
          }
          if (eqEmptyValue(import_xe_utils10.default.get(record, rowkey))) {
            import_xe_utils10.default.set(record, rowkey, getRowUniqueId());
          }
          return record;
        });
      },
      ...
      cacheRowMap(isReset) {
        ...
        if (treeConfig) {
          ...
          const childrenField = treeOpts.children || treeOpts.childrenField;
          const hasChildField = treeOpts.hasChild || treeOpts.hasChildField;
          import_xe_utils10.default.eachTree(tableFullTreeData, (row, index, items, path, parentRow, nodes) => {
          ...
          const aggregateOpts = computeAggregateOpts.value;
          const { mapChildrenField } = aggregateOpts;
          import_xe_utils10.default.eachTree(tableFullGroupData, (row, index, items, path, parentRow, nodes) => {
            const rowid = handleUpdateRowId(row);
            handleRowCache(row, index, items, parentRow ? -1 : index, parentRow, rowid, nodes.length - 1, toTreePathSeq(path));
          }, { children: mapChildrenField });
        } else {
      ...
      cacheSourceMap(fullData) {
        const { treeConfig } = props;
        const treeOpts = computeTreeOpts.value;
        const sourceData = import_xe_utils10.default.clone(fullData, true);
        const { handleUpdateRowId } = createHandleUpdateRowId($xeTable);
        ...
        if (treeConfig) {
          const childrenField = treeOpts.children || treeOpts.childrenField;
          import_xe_utils10.default.eachTree(sourceData, handleSourceRow, { children: treeOpts.transform ? treeOpts.mapChildrenField : childrenField });
        } else {
      ...
      handleColResizeMousedownEvent(evnt, fixedType, params) {
        ...
        if (column.children && column.children.length) {
          import_xe_utils10.default.eachTree(column.children, (childColumn) => {
        ...
        const updateEvent = (evnt2) => {
          ...
          if (resizableOpts.showDragTip && resizeTipElem) {
            resizeTipElem.textContent = getI18n6("vxe.table.resizeColTip", [Math.floor(resizeColumn.renderWidth + (isRightFixed ? dragPosLeft - dragLeft : dragLeft - dragPosLeft))]);
      ...
      handleRowResizeMousedownEvent(evnt, params) {
        ...
        if (cellEl) {
          ...
          cellMinHeight = Math.max(1, Math.ceil(import_xe_utils10.default.toNumber(cellStyle.paddingTop) + import_xe_utils10.default.toNumber(cellStyle.paddingBottom)));
        }
        ...
        if (isRowGroupStatus || treeConfig) {
          ...
          childRowList.forEach((vals) => {
            ...
            childList.forEach(checkMethod ? (item) => {
              ...
              const isSelect = checkField ? import_xe_utils10.default.get(item, checkField) : selectCheckboxMaps[childRowid];
            ...
            if (checkField) {
              import_xe_utils10.default.set(row, checkField, isSelected);
            }
            if (indeterminateField) {
              import_xe_utils10.default.set(row, indeterminateField, halfSelect);
            }
            if (isSelected) {
              if (!checkField) {
      ...
      updateAllCheckboxStatus() {
        ...
        rootList.forEach(checkMethod ? (row) => {
          ...
          const selected = checkField ? import_xe_utils10.default.get(row, checkField) : selectCheckboxMaps[childRowid];
        ...
        if (!isSelected && !halfSelect && showReserveStatus) {
          halfSelect = !import_xe_utils10.default.isEmpty(checkboxReserveRowMap);
        }
      ...
      handleBatchSelectRows(rows, checked, isForce) {
        ...
        if (checkField) {
          if ((treeConfig || isRowGroupStatus) && !checkStrictly) {
            import_xe_utils10.default.eachTree(rows, (row) => {
              if (isForce || (!checkMethod || checkMethod({ $table: $xeTable, row }))) {
                import_xe_utils10.default.set(row, checkField, checked);
                if (indeterminateField) {
                  import_xe_utils10.default.set(row, indeterminateField, false);
      ...
      handleToggleCheckRowEvent(evnt, params) {
        ...
        let checked = false;
        if (checkField) {
          checked = !import_xe_utils10.default.get(row, checkField);
        } else {
      ...
      handleCellRuleUpdateStatus(type, cellParams, cellValue) {
        ...
        if ($xeTable.hasCellRules) {
          if ($xeTable.hasCellRules(type, row, column)) {
            ...
            if (cell) {
              const customVal = !import_xe_utils10.default.isUndefined(cellValue);
            ...
            if (treeConfig) {
              if (transform) {
                ...
                if (oldRest && newRest) {
                  ...
                  const oldAllMaps = {};
                  import_xe_utils10.default.eachTree([dragRow], (item) => {
                  ...
                  const fullList = import_xe_utils10.default.toTreeArray(internalData.afterTreeFullData, {
                    key: rowField,
                    parentKey: parentField,
                    children: mapChildrenField
                  });
                  ...
                  if (isSelfToChildStatus && (isCrossDrag && isSelfToChildDrag)) {
                    import_xe_utils10.default.each(dragRow[childrenField], (childRow) => {
                      childRow[parentField] = dragRow[parentField];
                    });
                  }
                  dragRow[parentField] = isDragToChildFlag ? prevDragRow[rowField] : prevDragRow[parentField];
                  internalData.tableFullTreeData = import_xe_utils10.default.toArrayTree(fullList, {
                    key: rowField,
                    parentKey: parentField,
                    children: childrenField,
                    mapChildren: mapChildrenField
            ...
            return nextTick().then(() => {
              ...
              if (animation) {
                ...
                if (dragColWidth && dragAllTargetCols.length) {
                  const _newColIndex = import_xe_utils10.default.findIndexOf(visibleColumn, (column) => !!dragNewColumn && column.id === dragNewColumn.id);
                  ...
                  if (firstColRest) {
                    ...
                    import_xe_utils10.default.eachTree([newColumn], (column) => {
      ...
      scrollToTreeRow(row) {
        ...
        if (treeConfig || isRowGroupStatus) {
          ...
          const treeOpts = computeTreeOpts.value;
          const childrenField = treeOpts.children || treeOpts.childrenField;
          const matchObj = import_xe_utils10.default.findTree(tableFullData, (item) => $xeTable.eqRow(item, row), { children: isRowGroupStatus ? aggregateOpts.mapChildrenField : childrenField });
          if (matchObj) {
      ...
      setHoverRow(row) {
        ...
        if (el) {
          import_xe_utils10.default.arrayEach(el.querySelectorAll(`.vxe-body--row[rowid="${rowid}"]`), (elem) => addClass(elem, "row--hover"));
        }
      ...
      clearHoverRow() {
        const el = refElem.value;
        if (el) {
          import_xe_utils10.default.arrayEach(el.querySelectorAll(".vxe-body--row.row--hover"), (elem) => removeClass(elem, "row--hover"));
        }
        internalData.hoverRow = null;
      },
      /**
      ...
      findRowIndexOf(list, row) {
        return row ? import_xe_utils10.default.findIndexOf(list, (item) => $xeTable.eqRow(item, row)) : -1;
      },
      eqRow(row1, row2) {
        if (row1 && row2) {
          if (row1 === row2) {
    ...
    const renderRowExpandedVNs = () => {
      ...
      if (expandColumn) {
        ...
        tableRowExpandedList.forEach((row) => {
          ...
          if (isRowGroupStatus || treeConfig) {
            cellStyle.paddingLeft = `${rowLevel * (import_xe_utils10.default.isNumber(indent) ? indent : treeOpts.indent) + 30}px`;
          }
          let columnIndex = -1;
          let $columnIndex = -1;
          let _columnIndex = -1;
    ...
    watch(staticColumnFlag, () => {
      handleColumn(import_xe_utils10.default.clone(reactData.staticColumns));
    });
    ...
    hooks.forEach((options) => {
      ...
      if (setupTable) {
        ...
        if (hookRest && import_xe_utils10.default.isObject(hookRest)) {
    ...
    onMounted(() => {
      ...
      nextTick(() => {
        ...
        if (importConfig && importOpts.types && !importOpts.importMethod && !import_xe_utils10.default.includeArrays(import_xe_utils10.default.keys(importOpts._typeMaps), importOpts.types)) {
          warnLog("vxe.error.errProp", [`export-config.types=${importOpts.types.join(",")}`, importOpts.types.filter((type) => import_xe_utils10.default.includes(import_xe_utils10.default.keys(importOpts._typeMaps), type)).join(",") || import_xe_utils10.default.keys(importOpts._typeMaps).join(",")]);
        }
        if (exportConfig && exportOpts.types && !exportOpts.exportMethod && !import_xe_utils10.default.includeArrays(import_xe_utils10.default.keys(exportOpts._typeMaps), exportOpts.types)) {
          warnLog("vxe.error.errProp", [`export-config.types=${exportOpts.types.join(",")}`, exportOpts.types.filter((type) => import_xe_utils10.default.includes(import_xe_utils10.default.keys(exportOpts._typeMaps), type)).join(",") || import_xe_utils10.default.keys(exportOpts._typeMaps).join(",")]);
        }
        if (!props.id) {
        ...
        if ((rowOpts2.isCurrent || highlightCurrentRow) && props.keyboardConfig && keyboardOpts.isArrow && !import_xe_utils10.default.isBoolean(currentRowOpts.isFollowSelected)) {
          warnLog("vxe.error.notConflictProp", ["row-config.isCurrent", "current-row-config.isFollowSelected"]);
        }
        if ((columnOpts.isCurrent || highlightCurrentColumn) && props.keyboardConfig && keyboardOpts.isArrow && !import_xe_utils10.default.isBoolean(currentColumnOpts.isFollowSelected)) {
...
//# sourceMappingURL=chunk-PS3LO2VF.js.map
