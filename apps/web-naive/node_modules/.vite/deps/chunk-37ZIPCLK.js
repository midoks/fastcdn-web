...
var input_number_cssr_default = c([cB("input-number-suffix", `
...
// ../../node_modules/.pnpm/naive-ui@2.42.0_vue@3.5.17_typescript@5.8.3_/node_modules/naive-ui/es/input-number/src/utils.mjs
...
var InputNumber_default = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = use_theme_default("InputNumber", "-input-number", input_number_cssr_default, light_default, props, mergedClsPrefixRef);
    const {
      localeRef
  ...
  render() {
    ...
    const renderMinusButton = () => {
      return h(XButton, {
        ...
        icon: () => resolveSlot($slots["minus-icon"], () => [h(Icon_default, {
    ...
    const renderAddButton = () => {
      return h(XButton, {
        ...
        icon: () => resolveSlot($slots["add-icon"], () => [h(Icon_default, {
          clsPrefix: mergedClsPrefix
        }, {
...
//# sourceMappingURL=chunk-37ZIPCLK.js.map
