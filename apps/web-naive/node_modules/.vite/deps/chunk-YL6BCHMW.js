...
var index_cssr_default = cB("switch", `
 height: var(--n-height);
...
var Switch_default = defineComponent({
  ...
  setup(props) {
    ...
    const themeRef = use_theme_default("Switch", "-switch", index_cssr_default, light_default, props, mergedClsPrefixRef);
  ...
  render() {
    ...
    return h("div", {
      ...
      return h(IconSwitchTransition_default, null, {
...
//# sourceMappingURL=chunk-YL6BCHMW.js.map
