...
declare module "nitropack/types" {
  ...
  interface InternalApi {
    ...
    '/api/setup/create-api-node': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../api/setup/create-api-node.post').default>>>>
    }
    '/api/setup/install': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../api/setup/install.post').default>>>>
    }
    '/api/setup/test-database': {
      'post': Simplify<Serialize<Awaited<ReturnType<typeof import('../../api/setup/test-database.post').default>>>>
    }
    '/api/status': {
